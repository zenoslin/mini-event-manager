...
var MiniEvent = (function () {
    ...
    MiniEvent.prototype.once = function (evnetName, listener) {
        listener.isOnce = true;
        this.on(evnetName, listener);
        return this;
    };
    MiniEvent.prototype.off = function (evnetName, linstener) {
    ...
    MiniEvent.prototype.destory = function () {
        this._listenersMap = {};
    };
    return MiniEvent;
}());
